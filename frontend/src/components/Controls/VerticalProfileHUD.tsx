 ...
 * Floating vertical profile sounding HUD matching Image 1:
...
export const VerticalProfileHUD: React.FC<VerticalProfileHUDProps> = ({
  ...
  return (
    <div className="vertical-profile-hud">
      ...
      {/* Top Scientific Colormap Gradient Bar matching Image 1 */}
      ...
      <div className="vphud-chart-wrap">
        ...
        >
          ...
          {/* Observed Curve (Pink / Magenta as in Image 1) */}
      ...
      {/* Detailed Live Readings Box matching Image 1 */}
