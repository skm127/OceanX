      ...
      <div className="briefing-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="briefing-header">
          <div className="briefing-header-left">
            ...
            <h2>OCEAN-X COMMAND & CONTROL // MISSION BRIEFING</h2>
          </div>
        ...
        <div className="briefing-body">
          ...
          <div className="briefing-card highlight-card">
            ...
            <p>
              ...
              <strong> OCEAN-X</strong> automatically compares model predictions against in-situ robotic <strong>Argo profiling floats</strong>, 
          ...
          <div className="briefing-card">
            ...
            <p>
              ...
              <strong> high-octane rocket fuel for rapid cyclone intensification</strong>. OCEAN-X flags this instantly.
            </p>
          </div>
          ...
          <div className="briefing-card demo-card">
            ...
            <div className="demo-steps">
              ...
              <div className="demo-step">
                ...
                <div>
                  <strong>Analyze Model vs Reality:</strong> In the comparison drawer, examine the inverted depth profile. Notice how observed reality (amber) surges +3.2°C warmer than the NEMO model (cyan) at 110m.
                </div>
              </div>
              <div className="demo-step">
