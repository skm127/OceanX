...
export const SoundingStudioPage: React.FC<SoundingStudioPageProps> = ({
  ...
  const defaultId = initialProfileId || (profiles.length > 0 ? profiles[0].id : 'argo_2902345_0');
  ...
  const isCritical = anomalyAnalysis?.status === 'CRITICAL_ANOMALY' || anomalyCount >= 8;
  const isWarning = anomalyAnalysis?.status === 'WARNING' || (anomalyCount >= 3 && !isCritical);
              ...
              <div className={`studio-advisory-banner ${isCritical ? 'critical' : isWarning ? 'warning' : 'nominal'}`}>
                ...
                {isCritical && (
                  <div className="advisory-action-pill">
                    <strong>INCOIS Operational Guidance:</strong> Subsurface heat pool between 80m–220m inhibits vertical mixing and provides concentrated thermodynamic fuel for rapid tropical cyclone intensification. Assimilate sounding #{profile?.platform_id} to correct NEMO mixed-layer physics.
                  </div>
                )}
              </div>
            )}
                  ...
                  <div className="chart-legend-bar">
                    <div className="legend-items">
                      <div className="legend-item">
                        ...
                        <span>Numerical Model (NEMO 4D)</span>
                      </div>
                      <div className="legend-item">
                      ...
                      <div className="prov-section">
                        ...
                        <div className="prov-specs-grid">
                          <div className="prov-spec-item">
                            ...
                            <span className="prov-v">INCOIS IND-NEMO 4D Hydrodynamic</span>
                          </div>
                          <div className="prov-spec-item">
