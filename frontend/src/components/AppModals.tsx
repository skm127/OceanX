...
const TCHPInspectorCard = lazy(() => import('./Panels/TCHPInspectorCard'));
...
const OceanDossierModal = lazy(() => import('./Panels/OceanDossierModal'));
const RegionAnalysisModal = lazy(() => import('./Panels/RegionAnalysisModal'));
const TransectModal = lazy(() => import('./Panels/TransectModal'));
const GlobalSearchModal = lazy(() => import('./Panels/GlobalSearchModal'));
const AiAnalystModal = lazy(() => import('./Panels/AiAnalystModal'));
const DataProvenanceModal = lazy(() => import('./Panels/DataProvenanceModal'));
const OperationalSituationRoom = lazy(() => import('./Panels/OperationalSituationRoom'));
const LearnStoryJourney = lazy(() => import('./Panels/LearnStoryJourney'));
const DataManagerModal = lazy(() => import('./Panels/DataManagerModal'));
const CoLocationModal = lazy(() => import('./Panels/CoLocationModal'));
const SoundingStudioPage = lazy(() => import('./Panels/SoundingStudioPage'));
