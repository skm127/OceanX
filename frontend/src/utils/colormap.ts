...
/** Salinity colormap: light (fresh) → dark blue (saline) */
export const SALINITY_COLORMAP: ColorStop[] = [
  { position: 0.0, color: [255, 255, 220] },    // Pale yellow
  { position: 0.2, color: [180, 240, 180] },    // Light green
  { position: 0.4, color: [80, 200, 180] },     // Teal
  { position: 0.6, color: [40, 140, 200] },     // Blue
  { position: 0.8, color: [20, 60, 160] },      // Dark blue
  { position: 1.0, color: [10, 20, 80] },       // Navy
];
