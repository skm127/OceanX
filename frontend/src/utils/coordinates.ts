...
export const SECTOR_PRESETS: Record<SectorId, SectorPreset> = {
  all_india: {
    ...
    lon: 78.0,
    distance: 6.6,
    description: 'Arabian Sea, Bay of Bengal & Indian Peninsula',
  },
  arabian_sea: {
    id: 'arabian_sea',
    label: 'Arabian Sea',
    ...
    lon: 67.5,
    distance: 5.3,
    description: 'West Coast, Mumbai Basin & Lakshadweep',
  },
  bay_of_bengal: {
    id: 'bay_of_bengal',
    label: 'Bay of Bengal',
    ...
    lon: 88.5,
    distance: 5.3,
    description: 'East Coast, Andaman Sea & Ganga Outflow',
  },
  anomaly_target: {
    id: 'anomaly_target',
    label: 'Target #2902345',
    icon: '🎯',
    lat: 14.5,
    lon: 84.8,
    distance: 4.4,
    description: 'Active Anomaly Site: +3.2°C Thermal Blob at 120m',
  },
  equatorial: {
    id: 'equatorial',
    label: 'Equatorial Ocean',
    icon: '⚓',
    lat: 4.5,
    lon: 77.5,
    distance: 5.5,
    description: 'Southern Indian Ocean & Inter-tropical Convergence',
  },
};
